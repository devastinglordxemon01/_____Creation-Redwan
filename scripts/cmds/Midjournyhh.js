...
module.exports = {
  ...
  onStart: async function ({ api, event, args, message }) {
    ...
    message.reply("Please wait Midjourny process is on going...⏳", async (err, info) => {
      ...
      try {
        ...
        message.unsend(ui);
        message.reply({
          body: "Please reply with the image number generated from Midjourny (1, 2, 3, 4) to get the corresponding image in high resolution.",
