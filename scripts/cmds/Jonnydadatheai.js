...
async function a(api, event, args, message) {
  try {
    ...
    const b = "you are jonny sins ai"; // the more better content you give the  best it became
    const c = await d(a, b);
...
module.exports = {
  config: {
    name: "jonny",// add your ai name here
    version: "1.0",
    ...
    category: "ai",
    guide: {
      en: "{netflix}cmdName [a chat bot created by redwan and basically It's developed on a messenger gc name netflix]"// add guide based on your ai name
    }
  },
